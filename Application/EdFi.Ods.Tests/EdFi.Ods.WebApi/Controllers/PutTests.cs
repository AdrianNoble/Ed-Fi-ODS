...
namespace EdFi.Ods.Tests.EdFi.Ods.WebApi.Controllers
{
    public class StudentPutTests
    {
        ...
        //[TestFixture]
        //public class When_putting_a_non_existing_student : TestFixtureBase
        //{
        //    private Guid _id;
        ...
        //        //var studentcontroller = A.Fake<StudentsController>();
        ...
        //[TestFixture]
        //public class When_putting_an_existing_student : TestFixtureBase
        //{
        //    private Guid _id;
        //    private HttpResponseMessage _responseMessage;
        ...
        //        //    .ExecuteAsync(new CancellationToken())
        //        //    .GetResultSafely();
        //      //  var result = controller.Put(new StudentPut(), _id).Result;
        //    }
        ...
        //[TestFixture]
        //public class When_putting_a_student_that_has_been_modified : TestFixtureBase
        //{
        //    private Guid _id;
        //    private HttpResponseMessage _responseMessage;
        ...
        //        //controller.Request.Headers.AllEqual.Add(
        ...
        //[TestFixture]
        //public class When_putting_a_student_causes_referencial_exception : TestFixtureBase
        //{
        //    private Guid _id;
        //    private HttpResponseMessage _responseMessage;
        ...
        //[TestFixture]
        //public class When_putting_a_student_causes_validation_exception : TestFixtureBase
        //{
        //    private Guid _id;
        //    private HttpResponseMessage _responseMessage;
        ...
        //[TestFixture]
        //public class When_putting_student_unauthorized : TestFixtureBase
        //{
        //    [Test]
        ...
        //        var responseMessage = controller.Put(new StudentPut(), id).Result;
        ...
        public class When_putting_student_throws_unhandled_exception : TestFixtureBase
        {
            ...
            public void Setup()
            {
               ...
               // var serviceLocator = A.Fake<IServiceLocator>();
                //serviceLocator.Resolve(container.GetType());
                 var servicelocator= new AutofacServiceLocator(new Lazy<ILifetimeScope>(() => container));
               

                var pipelineFactory =
                    new PipelineFactory(
                        servicelocator, null, null, null, new SingleStepPipelineProviderForTest(typeof(UnhandledExceptionStep<,,,>)),
                        null);

                var controller = TestControllerBuilder.GetController<StudentsController>(pipelineFactory, id.ToString("N"));


                var result = controller.Put(new StudentPut(), id).Result;
            }
